...
The distribution of the observed distances is a product of detectability (sometimes referred to as "perception bias", @Marsh:1989ho) and the distribution of the animals (observed or unobserved) with respect to the line or point. We hope that our survey design will ensure that we can assume a distribution for the animals.
