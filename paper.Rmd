...
plot(x, line.availability, xlab = "Perpendicular distance", ylab = "pdf of object distances", type = "l", ylim = c(0,1.1), xlim = c(0,500), cex = set.cex, cex.lab = set.cex.lab, main = "Line Transect", cex.main = set.cex.main)
plot(x,y, xlab = "Perpendicular distance", ylab= "pdf of observed distances", type = "l", ylim = c(0,1.1), cex = set.cex, cex.lab = set.cex.lab)
...
plot(x, point.availability, xlab = "Radial distance", ylab = "pdf of object distances", type = "l", ylim = c(0,3300), xlim = c(0,500), cex = set.cex, cex.lab = set.cex.lab, main = "Point Transect", cex.main = set.cex.main)
point.observed <- y*point.availability
plot(x, point.observed, xlab = "Radial distance", ylab= "pdf of observed distances", type = "l", ylim = c(0,800), cex = set.cex, cex.lab = set.cex.lab)
...
```{r points-and-lines, fig.height=6, fig.width=7, echo=FALSE, message=FALSE, fig.cap="Left side plots show an example of a survey of a (1x1) area containing a population of 500 objects; blue dashed lines (top plot) and triangles (bottom plot) indicate sampler placement, red dots indicate detected individuals and grey dots give the locations of unobserved individuals. The right side of the figure shows histograms of observed distances (again, lines top and points bottom).\\label{fig:pointslines}"}
...
Good survey design is essential to produce reliable density and abundance estimates from distance sampling data. Survey design is beyond the scope of this article but we refer readers to @Buckland:2001vm [Chapter 7] and @buckland2015distance [Chapter 2] for introductory information; @Buckland:2004ts [Chapter 7] contains information on automated survey design using geographical information systems (GIS); @Thomas:2007wz gives an example of designing a distance sampling survey in a complex region.
