...
Conventional distance sampling relies on a number of assumptions. Firstly, like plot sampling, distance sampling assumes that the samplers have been located at random within the study area. By ensuring that the samplers are located independently of the objects in the study region we know that the "availability" of objects with respect to line transect samplers should be constant with increasing perpendicular distance. In contrast, 
