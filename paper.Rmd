...
```{r minke-hn-plot, fig.width=4, fig.height=4, fig.cap="Plot of fitted detection function overlayed on the histogram of observed distances for the minke whale data."}
plot(minke_hn)
```
...
```{r amakihi-hr}
amakihi_hr_obs <- ds(amakihi, truncation=82.5, model=df(model=~hr, scale=~obs), transect="point")
```
