...
plot(x, y, xlab = "Perpendicular distance (m)", ylab = "Probability of Detection", type = "l", ylim = c(0,1.1), main = "Probability of Detection", xaxp = c(0,1,5))
line.availability <- rep(1,100)
plot(x, line.availability, xlab = "Perpendicular distance (m)", ylab = "Availability", type = "l", ylim = c(0,1.1), xlim = c(0,500), yaxt = "n", main = "Expected Availability")
plot(x,y, xlab = "Perpendicular distance (m)", ylab= "", type = "l", ylim = c(0,1.1), yaxt = "n", main = "Observed Distribution")

#Point Transect example
plot(x, y, xlab = "Radial distance (m)", ylab = "Probability of Detection", type = "l", ylim = c(0,1.1), main = "Probability of Detection", xaxp = c(0,1,5))
point.availability <- 2*pi*x
plot(x, point.availability, xlab = "Radial distance (m)", ylab = "Availability", type = "l", ylim = c(0,3300), xlim = c(0,500), yaxt = "n", main = "Expected Availability")
point.observed <- y*point.availability
plot(x, point.observed, xlab = "Radial distance (m)", ylab= "", type = "l", ylim = c(0,800), yaxt = "n", main = "Observed Distribution")
