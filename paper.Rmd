...
```{r minke-hn-plot, echo=FALSE, warning=FALSE, fig.width=9, fig.height=9, fig.cap="Plot of fitted detection functions overlayed on the histograms of observed distances. Top row the minke whale data, half-normal model. Bottom row: average detection function for the amakihi data and marginal plot showing the levels of observer."}
par(mfrow=c(3,3))
