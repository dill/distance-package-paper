...
line.availability <- rep(0.002,100)
plot(x, line.availability, xlab = "Perpendicular distance", ylab = "pdf of object distances", type = "l", ylim = c(0,0.0022), xlim = c(0,500), cex = set.cex, cex.lab = set.cex.lab, main = "Line Transect", cex.main = set.cex.main)
plot(x,y.scaled, xlab = "Perpendicular distance", ylab= "pdf of observed distances", type = "l", ylim = c(0,0.0044), cex = set.cex, cex.lab = set.cex.lab)
...
\begin{table}
\caption{Modelling options for key plus adjustment series models for the detection function. Adapted from Buckland et al. (2001), section 2.4. For each key function the default adjustments are cosine in \pkg{Distance}.}
\begin{tabular}{llll}
\hline
