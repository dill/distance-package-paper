...
keywords:
  ...
  formatted: [distance sampling, abundance estimation, line transects, point transects, detection functions, Horvitz-Thomspn, "\\proglang{R}"]
  plain:     [distance sampling, abundance estimation, line transects, point transects, detection functions, Horvitz-Thomspn, R]
preamble: >
  \usepackage{amsmath}
  \usepackage{amssymb}
